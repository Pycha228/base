(function () {
    ...
    // Добрый день! Внесу изменения в дизайн. Добавлю небходимые блоки и сделаю 
    // необходимые правки внутри и снаружи. Предлагаю сделать 
    // бесплатную диагностику. Для начала работы мне нужен доступ к админке. По срокам
    // предварительно 4 дня. На случай падения метеорита. по цене 3000 рублей. Надеюсь сработаемся
